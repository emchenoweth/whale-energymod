...
for(n in 1:nrow(EnergyParameters)){
  ...
  assign(paste(EnergyParameters[n,]$Prey.Group),
         Energy_gain.nodf(mass_ind = EnergyParameters[n,]$Mean.Wet.mass,
                   ...
                   proportion_captured = EnergyParameters[n,]$CaptureProp_surface,
...
results
results.NoWhales<-results #with CaptureProp_NoWhaleBehave
results.Surface<-results #With CaptureProp_surface
results.Subsurface<-results #With CaptureProp_subsurface
