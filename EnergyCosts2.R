...
library("chron", lib.loc="~/R/win-library/3.4")
...
EnergyCosts<-read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/EnergyCosts2.csv")

AllLunges<- rbind.fill(read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_108a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_109a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_110a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_111a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_112a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_113a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_113d_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn14_110a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn14_113a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn14_113b_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn14_114a_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn12_262b_lunge_summaryA.csv")
                       ,read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn12_262a_lunge_summaryA.csv"))
#write.csv(AllLunges, "H:/Analysis/Chapter3/Tags/Chapter3Lunges/AllLunges.csv")
read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/AllLunges.csv")
AllLunges<-read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/AllLunges.csv")
...
AllLunges[AllLunges$max.speed>7 & !is.na(AllLunges$max.speed),]$max.speed<-NA
...
mn13_108a_diveSUMA<-read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_108a_diveSUMA.csv")
mn13_108a_diveSUMA$tag<- "mn13_108a"
mn13_109a_diveSUMA<-  read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_109a_diveSUMA.csv")
mn13_109a_diveSUMA$tag<- "mn13_109a"
mn13_110a_diveSUMA<-    read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_110a_diveSUMA.csv")
mn13_110a_diveSUMA$tag<-"mn13_110a"
mn13_111a_diveSUMA<-    read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_111a_diveSUMA.csv")
mn13_111a_diveSUMA$tag<-"mn13_111a"
mn13_112a_diveSUMA<-     read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_112a_diveSUMA.csv")
mn13_112a_diveSUMA$tag<-"mn13_112a"
mn13_113a_diveSUMA<-     read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_113a_diveSUMA.csv")
mn13_113a_diveSUMA$tag<-"mn13_113a"
mn13_113d_diveSUMA<-     read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn13_113d_diveSUMA.csv")
mn13_113d_diveSUMA$tag<-"mn13_113d"
mn14_110a_diveSUMA<-     read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn14_110a_diveSUMA.csv")
mn14_110a_diveSUMA$tag<-"mn14_110a"
mn14_113a_diveSUMA<-    read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn14_113a_diveSUMA.csv")
mn14_113a_diveSUMA$tag<-"mn14_113a"
mn14_113b_diveSUMA<-    read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn14_113b_diveSUMA.csv")
mn14_113b_diveSUMA$tag<-"mn14_113b"
mn14_114a_diveSUMA<-     read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn14_114a_diveSUMA.csv")
mn14_114a_diveSUMA$tag<-"mn14_114a"
mn12_diveSUMA<-     read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn12_diveSUMA2.csv")
mn12_262b_diveSUMA<-     read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn12_262b_diveSUMA.csv")
mn12_262a_diveSUMA<-     read.csv("H:/Analysis/Chapter3/Tags/Chapter3Lunges/mn12_262a_diveSUMA.csv")
...
for (n in which(is.na(EnergyCosts$meta.costs.mean))){
  ...
  EnergyCosts[n,]$Î..speed<-median(sub$delta.speed, na.rm = TRUE)
...
ggplot()+geom_smooth(aes(breaths_lunge, Î..speed), data = EnergyCosts[-10,], method = "lm")+geom_point(aes(breaths_lunge, Î..speed, color = tag), data = EnergyCosts[-10,])
...
mod<-lm(breaths_lunge ~Î..speed +lunge_min +lunge_min^2 , data = EnergyCosts)
plot(EnergyCosts$Î..speed,EnergyCosts$lunge_min)
plot(step(mod))
summary(step(mod))


mod<-lm(breaths_lunge ~max.speed+Î..speed  , data = EnergyCosts)
summary(step(mod))
